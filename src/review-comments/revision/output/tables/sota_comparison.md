# Comparison with 2024–2025 SOTA SHAP-based EDM methods, re-implemented on our dataset under identical 5-fold stratified CV with SMOTE applied on training folds only.
